...
import { Utensils, ClipboardCheck, Users, Wallet, ShoppingCart, Palette, ChevronDown, Check, LogOut, CreditCard } from 'lucide-react';
      ...
      <header className={`sticky top-0 z-40 text-white shadow-md transition-all duration-300 ${headerGradientMap[currentTheme]}`}>
        <div className="max-w-7xl mx-auto px-3 py-2.5 sm:px-4 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            {/* 3D ATM Card Launcher Button - Only shown when user is in viewer mode */}
            {onOpenATMModal && currentRole === 'viewer' && (
              <button
                type="button"
