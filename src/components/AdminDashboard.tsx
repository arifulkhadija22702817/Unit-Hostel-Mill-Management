...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  <div className="flex flex-wrap items-center gap-2 border-b border-slate-200 dark:border-slate-800 pb-2">
    <button
      ...
      className={`px-4 py-2.5 rounded-2xl font-black text-xs transition-all cursor-pointer flex items-center gap-2 ${activeTab === 'editors'
    ...
    <button
      ...
      className={`px-4 py-2.5 rounded-2xl font-black text-xs transition-all cursor-pointer flex items-center gap-2 ${activeTab === 'active'
    ...
    <button
      ...
      className={`px-4 py-2.5 rounded-2xl font-black text-xs transition-all cursor-pointer flex items-center gap-2 ${activeTab === 'pin'
    ...
    <button
      ...
      className={`px-4 py-2.5 rounded-2xl font-black text-xs transition-all cursor-pointer flex items-center gap-2 ${activeTab === 'logs'
